...
const buildTheme = (mode: ThemeMode) => {
  ...
  return createTheme({
    ...
    typography: {
      ...
      h1: { fontWeight: 700, letterSpacing: '-0.021em' },
      h2: { fontWeight: 700, letterSpacing: '-0.019em' },
      h3: { fontWeight: 700, letterSpacing: '-0.017em' },
      h4: { fontWeight: 700, letterSpacing: '-0.014em' },
      h5: { fontWeight: 650, letterSpacing: '-0.011em' },
      h6: { fontWeight: 650, letterSpacing: '-0.008em' },
      subtitle1: { letterSpacing: '-0.005em' },
